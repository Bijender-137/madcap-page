            ...
            <div className="timeBox position-relative z-3 bg_lite_dark d-flex flex-column justify-content-center align-items-center px-1">
                <div className="d-flex justify-content-center gap-2 px-md-4 mx-md-3 pt-3 mt-2">
                    <div className="timeContentBox bg-white d-flex justify-content-center align-items-center">
                        <p className='color_dark_red ff_Badabb fw-normal mb-0 line-h-16 text-center fs_3sm'>{days}<span className="d-block mb-0 fs_xxs line-h-14 color_white_400 ff_Samaritan">days</span></p>
                    </div>
                    <div className="timeContentBox bg-white d-flex justify-content-center align-items-center">
                        <p className='color_dark_red ff_Badabb fw-normal mb-0 line-h-16 text-center fs_3sm'>{hours} <span className="d-block mb-0 fs_xxs line-h-14 color_white_400 ff_Samaritan">hours</span></p>
                    </div>
                    <div className="timeContentBox bg-white d-flex justify-content-center align-items-center">
                        <p className='color_dark_red ff_Badabb fw-normal mb-0 line-h-16 text-center fs_3sm'>{minutes} <span className="d-block mb-0 fs_xxs line-h-14 color_white_400 ff_Samaritan">minutes</span></p>
                    </div>
                    <div className="timeContentBox bg-white d-flex justify-content-center align-items-center">
                        <p className='color_dark_red ff_Badabb fw-normal mb-0 line-h-16 text-center fs_3sm'>{seconds} <span className="d-block mb-0 fs_xxs line-h-14 color_white_400 ff_Samaritan">seconds</span></p>
                    </div>
                </div>
