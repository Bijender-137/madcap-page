        ...
        <div className="z-100 position-relative z-3">
          ...
          <div className="d-flex justify-content-center position-relative">
            <img
              src={heroMan}
              alt="heroman"
              className=" heroMan d-md-none pt-20 manImg position-absolute"
            />
          </div>
          <div className="d-flex justify-content-center justify-content-md-end pe-md-5 w-100 pb-4 pb-md-5 mb-md-4 z-2 mt-250 mt-md-0 position-relative">
            <div className="d-flex flex-column align-items-center">
              <Countdown />
              <Buybox />
              <p className="ff_MangaMaster fs_xxs text-white fw-normal pt-2 letter_spac_359 px-4 px-sm-5 mx-sm-5 px-md-0 mx-md-0">
                2 Billion Tokens at 0.0025 each! Grab them in the first 48 hours
                ...
                <div className="yellowBox_content bg_primary position-relative">
                  <div className="border_sm_8 z-2 position-relative">
                    <p className="fs_2xs fw-bold ff_CrimeFighter line-h-14 ">
                      ...
                      unlock hand-drawn
                      <span className="d-md-block">NFTs, and become</span>a
                      financial hero
                    </p>
